...
class UI:
    ...
    def choose_character(self):
        ...
        print("-" * 60)
        print("1. [Rodolfo, o 'Mão de Alface']")
        print("   > Classe: Bárbaro Furioso")
        print("   > Vantagem Inicial: +1 DADO DE FÚRIA (Preto)")
        print("   > Lema: 'Eu vim aqui pra bater e comer pudim. E acabou o pudim.'")
        print("-" * 60)
        print("2. [Gertrudes, a 'Cobradora de Dívidas']")
        print("   > Classe: Mercenária Tática")
        print("   > Vantagem Inicial: +2 GLÓRIA (Ouro)")
